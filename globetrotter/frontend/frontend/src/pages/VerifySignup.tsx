...
export const VerifySignup: React.FC = () => {
  ...
  const [email, setEmail] = useState<string>((location.state as { email?: string } | null)?.email ?? localStorage.getItem('globetrotter_pending_email') ?? sessionStorage.getItem('globetrotter_pending_email') ?? '');
  ...
  const handleResend = async () => {
    if (!email.trim()) {
      setError('Please enter your email before requesting another code.');
      return;
    }
    ...
    try {
      await resendOtp(email, 'signup_verify');
    ...
    <div className="auth-page">
      ...
      <div className="auth-split-container">
        <div className="auth-banner">
          <img src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=1200&q=80" alt="Ocean view" className="banner-bg-image" />
          <div className="banner-overlay" />
          <div className="banner-content">
            <div className="banner-brand-badge"><Globe size={24} /><span>GlobeTrotter</span></div>
            <h2 className="banner-heading">Verify your email</h2>
            <p className="banner-text">Enter the 6-digit code we sent to complete signup and unlock your account.</p>
          </div>
        </div>
        ...
        <div className="auth-form-container">
          <div className="form-box">
            ...
            <p className="form-subtitle">We sent a 6-digit code to your email.</p>
            ...
            <form onSubmit={handleSubmit} className="auth-form" noValidate>
              ...
              <div className="auth-field-group">
                <label htmlFor="verify-otp" className="auth-field-label">Verification Code</label>
                <div className="auth-input-wrapper">
                  <input
                    id="verify-otp"
                    type="text"
            ...
            <p className="auth-footer-text">
              Need another account? <Link to="/register">Create account</Link>
            </p>
          </div>
        </div>
      </div>
